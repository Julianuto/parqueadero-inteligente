...
?>
    <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
     <html>
       <head>
           <title>Informe de ganancia</title>
...
?>
        <tr valign="top">
             <td height="20%" align="center"
                    ...
                    style="color: #FFFFFF;
			             font-weight: bold">
			    <font FACE="Century Gothic" SIZE=2 color="#000044" > <b><h1>Informe de ganancia</h1></b></font>
	       </td>
...
?>
 ...
 <?php }?>
                ...
                <div align="center">
                <form action="/scripts/generar_informes.php">
                 <?php
                ...
                <b>Ganancia de todos los dias seleccionados: </b>$<?php echo $row5[0];?>  <br><br>
                </font>
                </form>
