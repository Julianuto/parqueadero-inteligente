         ...
         <tr>
			 ...
			 <tr>
				...
				<td bgcolor="#F4B120" align=center>  <font FACE="Century Gothic" SIZE=2 color="#000000"><b>
				  <font FACE="arial" SIZE=2 color="#000000"> <b>Nombre</b></font>
				</td>
...
?>
				...
				<td bgcolor="#EEEEEE" align=center>
				  <font FACE="Century Gothic" SIZE=2 color="#000000"> <b><?php echo $ubicacion; ?></b></font>
                	...
                	<td bgcolor="#EEEEEE" align=center>
                <font FACE="Century Gothic" SIZE=2 color="#000000"> <a href="prog_Tulcanadmin.php?id_park=<?php echo $id_park; ?>"> <img src="../img/ver.png" border=0 width=20 height=20></a></font>
                     	</td>
					<td bgcolor="#EEEEEE" align=center>
				  <font FACE="Century Gothic" SIZE=2 color="#000000"> <b><?php echo $latitud; ?></b></font>
				</td>
					<td bgcolor="#EEEEEE" align=center>
				  <font FACE="Century Gothic" SIZE=2 color="#000000"> <b><?php echo $longitud; ?></b></font>
				</td>

        <td bgcolor="#EEEEEE" align=center>
				  <font FACE="Century Gothic" SIZE=2 color="#000000"> <a href="tabla_parq_mod.php?id_park=<?php echo $id_park_enc; ?>"> <img src="../img/ayuda.png" border=0 width=20 height=20></a></font>
				</td>
...
?>
                     ...
                     <tr>      <td align=center>
        <a href="tabla_parq_add.php">  <font face="Century Gothic" SIZE=2><b>Agregar nuevo parqueadero </b></font></a>
      </td>
      </tr>
                   </table>
<br><br><hr>
