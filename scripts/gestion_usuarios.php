           ...
           if (($id_con == "") and ($nombre_con != ""))
             {
              if ($estado == "2")
                ...
                $sql1 = "SELECT * from usuario where nombre LIKE '%$nombre_con%' and activo='$estado' order by nombre";
              }
           if (($id_con != "") and ($nombre_con != ""))
             {
              if ($estado == "2")
                 $sql1 = "SELECT * from usuario where nombre LIKE '%$nombre_con%' and numero_id='$id_con'";
              else
                $sql1 = "SELECT * from usuario where nombre LIKE '%$nombre_con%' and numero_id='$id_con' and activo='$estado'";
             }      
          }
         else
             $sql1 = "SELECT * from usuario order by nombre";
...
?>
                       ...
                       <tr>
      <td align=center>
        <a href="gestion_usuarios_add.php"> <font face="Century Gothic" SIZE=2><b>Agregar nuevo usuario </b></a> </font>
      </td>
      </tr>
                   </table>
<br><br><hr>
