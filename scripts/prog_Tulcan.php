...
$sqlubi = "SELECT * from parqueadero where ID_PARK='$id_park_enc'"; //CONSULTA LA ULTIMA UBICACION AGREGADA A LA TABLA UBICACIONES
...
?>
    <div id="map"></div>
  <form method="POST" action="prog_Loc_Tulcan.php?id_park=<?php echo $id_park_enc;?>">
