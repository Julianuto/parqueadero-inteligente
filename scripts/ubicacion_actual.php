...
?>
	  ...
	  <table width=80% border=0 align=center>
               <tr>
               <td bgcolor="#228B22" align=center>
				  <font FACE="Century Gothic" SIZE=2 color="#FFFFFF"> <b>Calcular parqueadero mas cercano</b></font>
               </td>
               </tr>
               <tr>
 ...
 <form method="POST" action="accion.php">
    ...
    <font FACE="Century Gothic" SIZE=2 color="#000000"><input type="submit" value="Consultar">
 </form>
     ...
     <?php
      if (isset($_GET["mensaje"]))
      {
        ...
        if ($_GET["mensaje"]!=""){?>
                    ...
                    <?php
                       if ($mensaje == 1)
                         echo "<td bgcolor=#EEEEEE class=_espacio_celdas_p
