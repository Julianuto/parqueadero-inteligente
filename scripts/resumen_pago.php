...
<body onkeydown="return (event.keyCode != 116)">
     ...
     <?php
        ...
        $sqlusu1 = "UPDATE reserva set id_estado=1 where id_reserva='$id_reserva'";
...
include "menu_usuario.php";
        $id_reserva=$_GET['id_reserva'];
         $sqlusu2 = "select clave from reserva where id_reserva='$id_reserva'";
        $resultusu2 = $mysqli->query($sqlusu2);
        $row12=$resultusu2->fetch_array(MYSQLI_NUM);
?>
            <tr>
                  <td width="25%" height="20%" align="center"
                    bgcolor="#FF8080" class="_espacio_celdas_p"
                    style="color:red;
			             font-weight: bold, ; font-size:35px">  <font FACE="Century Gothic" SIZE=5 color="#000000">
                    <?php
                     echo "Su codigo de salida es: " ;
                     echo $row12[0];
                    ?>
                  </td>
                </tr>
