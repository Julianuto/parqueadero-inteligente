<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    ...
    <img src="../img/sip.png" border=0 width=150 height=150>
         ...
         <h1> <font color=white face="Century Gothic">SALIDA</font></h1>
         </td>
         </tr> </table>
         ...
         <form method="POST" action="validar_salida.php">
         <input type=number value="" name="passwd1" maxlength="3" style="color:black;height:50px; width:60px;font-size:35px" required>
         <br><br>
         <input  type=submit value="Ingresar" name="Enviar" style="color:black;height:50px; width:150px; font-size:30px;font-family: Century Gothic">
         <br><br>
         <?php
                ...
                ?>
                  ...
                  <td width="25%" height="20%" align="center"
                    ...
                    <?php
                       ...
                       if ($mensaje == 3)
                         echo "El codigo ha sido inactivado por exceder el tiempo de salida";
                       if ($mensaje == 4)
                         echo "";
                    ?>
                  </td>
